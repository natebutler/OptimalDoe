...
We define the D-criteria as $D(\mathbf{X})=\frac{1}{\mathbf{F'F}}$, and we are trying to find the minimize the determinant of this information matrix created.

We define the A_criteria as $A(\mathbf{X})=tr[(\mathbf{F'F})^{-1}]$, and we are trying to minimize the trace of the information matrix created.
